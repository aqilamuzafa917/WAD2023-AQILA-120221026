...
if (isset($_POST["hitung_bmi"])) {
    ...
    $converttb=$tinggi_badan/100;
    $hasilbmi = $berat_badan/($converttb*$converttb);
// **********************  1  ************************** 
...
elseif ($hasilbmi<=18.4) {
    $status="underweight";
    
}
elseif ($hasilbmi>=25 && $hasilbmi<=39.9) {
    $status="overweight";
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" name="hitung_bmi" class="btn btn-primary mb-3 mt-3 w-100">Hitung BMI</button>
                    </form>
